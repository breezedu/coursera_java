...
public class Week01_Hello_RE {
	...
	public void sayHello() throws IOException{
		...
		URLResource hello = new URLResource("http://www.dukelearntoprogram.com/java/somefile.txt");
		...
		//Type mismatch: cannot convert from element type Object to String
		 ...
		 FileResource FRes = new FileResource("src/files/animals.txt");
	...
	public static void main(String[] args) throws IOException{
		...
		Week01_Hello_RE hw1 = new Week01_Hello_RE();
